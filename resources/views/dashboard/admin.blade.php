...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <p class="text-gray-600">Welcome back, {{ Auth::user()->name }}! Here's an overview of all incidents.</p>
    </div>
        ...
        <div class="overflow-hidden">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500">When incidents are reported, they will appear here.</p>
                </div>
            @endif
        </div>
    </div>
