@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col space-y-4">
        <!-- Mobile Pagination -->
        <div class="flex flex-col space-y-3 sm:hidden">
            ...
            <div class="flex justify-between space-x-2">
                @if ($paginator->onFirstPage())
                    <span class="flex-1 relative inline-flex items-center justify-center px-3 py-2 text-xs font-medium text-gray-500 bg-gray-100 border border-gray-300 cursor-default leading-5 rounded-md">
                        <i class="fas fa-chevron-left mr-1"></i>
                        {!! __('pagination.previous') !!}
                    </span>
                @else
                    <a href="{{ $paginator->previousPageUrl() }}" class="flex-1 relative inline-flex items-center justify-center px-3 py-2 text-xs font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                        <i class="fas fa-chevron-left mr-1"></i>
                        {!! __('pagination.previous') !!}
                    </a>
                @endif
